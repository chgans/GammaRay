...
ObjectVisualizerClient::ObjectVisualizerClient(QObject *parent)
    : ObjectVisualizerInterface(parent)
{}

ObjectVisualizerClient::~ObjectVisualizerClient() = default;

void ObjectVisualizerClient::clearHistory()
{
    Endpoint::instance()->invokeObject(objectName(), "clearHistory");
}

void ObjectVisualizerClient::recordAll()
{
    Endpoint::instance()->invokeObject(objectName(), "recordAll");
}

void ObjectVisualizerClient::recordNone()
{
    Endpoint::instance()->invokeObject(objectName(), "recordNone");
}

void ObjectVisualizerClient::showAll()
{
    Endpoint::instance()->invokeObject(objectName(), "showAll");
}

void ObjectVisualizerClient::showNone()
{
